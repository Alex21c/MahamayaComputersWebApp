  ...
  return (
    <>
      ...
      <div>
        ...
        <p>
          Welcome to Mahamaya Computers online store. We prioritize the privacy
          of our customers and are committed to protecting your personal
          information. This Privacy Policy explains how we collect, use, and
          safeguard your data when you use our services, including when signing
        ...
        <ul>
          <li>
            ...
            with your Google account, we may collect basic information such as
          ...
          <li>
            <strong>Device Information:</strong> Information about the devices
            you use to access our website, such as IP addresses, browser type,
            and device type.
          </li>
          <li>
        ...
        <p>
          When you choose to sign in/up using your Google account, we may
          collect your profile information as permitted by Google's terms. This
          helps us streamline the registration process. We do not have access to
          your Google password, and Google handles the authentication process.
        </p>
        ...
        <ul>
          ...
          <li>
            ...
            obligations or enforce our terms and conditions.
          </li>
        </ul>
        ...
        <p>
          ...
          method of electronic storage is entirely secure, and we cannot
        ...
        <ul>
          ...
          <li>
            Requesting deletion of your data, subject to certain legal
            obligations
          </li>
        </ul>
