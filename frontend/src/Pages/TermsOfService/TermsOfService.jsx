  ...
  return (
    <div>
      ...
      <p>
        ...
        purposes and in accordance with our terms. You are prohibited from using
        the website in a way that violates any local, state, national, or
      ...
      <p>
        ...
        {genLinkTag("/privacy-policy", "privacy-policy")}, which explains how we
      ...
      <p>
        ...
        to change without notice. We reserve the right to modify or discontinue
      ...
      <p>
        ...
        purchase. By providing payment information, you authorize us to process
        your order and collect payments as required.
      </p>

      <h2>6. Shipping and Delivery</h2>
      <p>
        We will make reasonable efforts to ship your order within the estimated
        timeframe. Delivery times are subject to change due to factors beyond
        our control. You are responsible for providing accurate shipping
        information to avoid delays.
      </p>

      <h2>7. Return Policy</h2>
      <p>
        <strong>Products once shipped cannot be returned or exchanged.</strong>{" "}
      ...
      <p>
        ...
        As a retailer, Mahamaya Computers does not provide any warranty services
        directly. Customers are responsible for contacting the brand's customer
        care center for warranty claims, and items must be taken or shipped
        directly to the brand's authorized service center as per the company's
        warranty policy.
      </p>
      ...
      <p>
        ...
        services. This includes any loss of data, business interruption, or loss
        of profits.
      </p>
      ...
      <p>
        ...
        losses arising out of your use of the website, violation of these Terms,
      ...
      <p>
        ...
        we believe you have violated these Terms or engaged in inappropriate
        behavior. You may also terminate your account by contacting us directly.
      </p>
      ...
      <p>
        ...
        post the updated version on this page and update the effective date. We
