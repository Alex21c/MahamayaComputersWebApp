...
export default function GoogleAuthButton({
  ...
  return (
    <button
      ...
      className="px-[1rem] py-[.5rem] bg-gradient-to-br from-yellow-300 to-yellow-500 rounded-md  text-slate-900 font-medium hover:from-yellow-500 hover:to-yellow-300 flex items-center gap-[.5rem] w-[100%] justify-center"
    >
